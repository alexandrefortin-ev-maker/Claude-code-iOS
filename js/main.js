...
(function () {
  ...
  const EN = {
    ...
    "phare.rdc.p2": "The kitchen is professional equipment in a cabinetmaker's setting: Sub-Zero appliances — two refrigerators and two freezers —, induction cooktop, steam oven, pot filler above the range, all set into quartz counters and custom millwork by a Napierville cabinetmaker whose work runs throughout the residence.",
    ...
    "phare.bienetre.p1": "This is where Le Phare stops being a house and becomes a private resort. The indoor pool stretches beneath a yellow-cedar ceiling whose scent perfumes the air; a glazed footbridge links it to the gym, so you pass from workout to swim without ever leaving the light.",
    ...
    "phare.loft.p1": "Two integrated double garages — four cars sheltered and heated — are topped by a fully finished loft: engineered flooring, a full bathroom and a freight lift to bring up luggage or equipment effortlessly. Office, studio, extra guest quarters: the space lends itself to anything. Beneath the house, a 5,330 sq. ft. basement notably houses a vast games room.",
    ...
    "chalet.ext.p1": "Behind the house, a paver terrace (2021-2022) steps down to the heated salt-water pool (2021), sheltered by a retractable awning. A few steps more and you reach the lake: the pool pavilion, built in 2010 and renovated in 2024-2025, awaits the summer afternoons with its powder room, terrazzo floor and aluminum glass doors — the reception annex every swim dreams of.",
    ...
    "annexes.pavillon.d": "At the water's edge: powder room, terrazzo floor and aluminum glass doors — the reception spot for swimming afternoons.",
    ...
    "terre.p1": "In June, lavender blooms across the former organic plantation. The forest, under a complete management plan, opens onto kilometres of fenced trails — and the lake waits, with its two docks and electric pontoon.",
    ...
    "terre.l1": "Lavender field — former organic production",
    ...
    "terre.l6": "Machinery included: golf carts, tractors, two snowmobiles (electric and gas), watercraft",
    ...
    "auto.g3d": "In every habitable building, with underground power across part of the estate.",
    "auto.g4t": "600 amperes",
    "auto.g4d": "A 600 A main service and four 220 V charging stations for electric vehicles.",
    ...
    "auto.g6d": "At Le Phare: lighting, blinds, recessed curtains, motorized screens and cameras — at your fingertips.",
